              ...
              <div class="card-body p-4 p-lg-5 text-black">
                <form action="/updateProfile" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-outline mb-2">
                    ...
                    <input  type="text" name="name" id="nama" class="form-control form-control-lg" placeholder="masukan nama lengkap..." require>
                  </div>
                  <div class="form-outline mb-2">
                  ...
                  <div class="form-outline mb-2">
                    ...
                    <input type="Password" name="password" id="pass" placeholder="masukan password..." required class="form-control form-control-lg" /> 
                  </div>
                  <div class="form-outline mb-2">
                    <label class="form-label" for="repass">Confirm Password</label>
                    <input type="Password" name="password_confirmation" id="repass" class="form-control form-control-lg" required placeholder="masukan konfirmasi password..." /> 
                  </div>
                  <div class="form-outline mb-2">
                    <label class="form-label" for="nohp">Phone Number</label>
                    <input type="text" name="phone_number" id="nohp" required class="form-control form-control-lg" placeholder="masukan nomor handphone...."/>
                  </div>
                  <div class="form-outline">
                    <label class="form-label mb-3" for="nohp">Daftar sebagai</label><br>
                    <div class="form-check form-check-inline mb-3">
                      <input class="form-check-input" type="radio" name="role" id="inlineRadio1" value="Pasien">
                      <label class="form-check-label" for="inlineRadio1">Pasien</label>
                    </div>
                    <div class="form-check form-check-inline mb-3">
                      <input class="form-check-input" type="radio" name="role" id="inlineRadio2" value="Terapis">
                  ...
                  <div class="pt-0 mt-3 mb-3">
                    ...
                    <p class="mb-5 pb-lg-2 mt-2" style="color: #393f81;">Already have an acount? <a href="/login">Sign in</a></p>
                  </div>
                </form>
              </div>
            </div>
